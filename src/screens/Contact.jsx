  ...
  return (
    <section className='flex sm:flex-col relative  min-h-screen h-full'>
      ...
      >
        ...
        <div className='flex-0 flex md:flex-col sm:flex-col xs:flex-col relative w-full xl:pt-5 2xl:pt-5 sm:pr-10'>
          <motion.div
            initial='hidden'
            whileInView='visible'
            viewport={{ once: true }}
          ...
          >
            <div className='flex-row'>
              ...
              <div className='flex flex-row 3xl:space-x-44 2xl:space-x-32 xl:space-x-20 lg:space-x-4 md:space-x-10 sm:space-x-4 flex-wrap justify-center pt-20'>
          ...
          <motion.div
            ...
            className='flex-2 flex justify-center items-center w-1/2 -mt-4 pr-40 sm:pr-10 m-10  md:w-full sm:w-full xs:w-full pt-10 sm:pt-20 xs:pt-[90px]'
          >
            <ContactCard />
          </motion.div>
        </div>
